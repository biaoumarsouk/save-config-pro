...
class SousReseaux(tk.Frame):
    ...
    def create_widgets(self):
        """Crée les widgets principaux avec grid layout centré"""

        # === Configuration du layout principal (3 lignes)
        self.grid_rowconfigure(0, weight=0)  # Haut : fixe
        self.grid_rowconfigure(1, weight=1)  # Centre (table) : extensible
        self.grid_rowconfigure(2, weight=0)  # Bas : fixe
        ...
        # Conteneur centré pour le titre + mode
        ...
        self.device_count_var = tk.StringVar(value="Réseaux détectés : 0")
